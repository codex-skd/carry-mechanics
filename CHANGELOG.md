...
- **Nombre de JAR con versión del cargador**: el artefacto ahora se compila como `carry_mechanics-26.1.2-neoforge-26.1.2.78-1.0.2.jar` (se añade la versión de cargador/NeoForge al nombre del archivo). Empaquetado y documentación; sin cambios de funcionalidad.
